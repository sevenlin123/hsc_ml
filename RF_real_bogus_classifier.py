...
#				self.ns[:]['flux_psf_apcorr'], self.ns[:]['flux_psf_apcorr_err']]
		ns_list = [self.ns[:]['parent'], self.ns[:]['ext_shapeHSM_HsmSourceMoments_xx'], 
				self.ns[:]['ext_shapeHSM_HsmSourceMoments_yy'], self.ns[:]['ext_shapeHSM_HsmSourceMoments_xy'],
				self.ns[:]['ext_shapeHSM_HsmPsfMoments_xx'], self.ns[:]['ext_shapeHSM_HsmPsfMoments_yy'],
				self.ns[:]['ext_shapeHSM_HsmPsfMoments_xy'],
				self.ns[:]['base_SdssShape_xx'], self.ns[:]['base_SdssShape_yy'], self.ns[:]['base_SdssShape_xy'],
				self.ns[:]['base_SdssShape_psf_xx'], self.ns[:]['base_SdssShape_psf_yy'], self.ns[:]['base_SdssShape_psf_xy'],
				self.ns[:]['base_CircularApertureFlux_3_0_flux'], self.ns[:]['base_CircularApertureFlux_4_5_flux'], 
				self.ns[:]['base_CircularApertureFlux_6_0_flux'], self.ns[:]['base_CircularApertureFlux_9_0_flux'],
				self.ns[:]['base_CircularApertureFlux_12_0_flux'], self.ns[:]['base_CircularApertureFlux_17_0_flux'],
				self.ns[:]['base_CircularApertureFlux_3_0_fluxSigma'], self.ns[:]['base_CircularApertureFlux_4_5_fluxSigma'], 
				self.ns[:]['base_CircularApertureFlux_6_0_fluxSigma'], self.ns[:]['base_CircularApertureFlux_9_0_fluxSigma'],
				self.ns[:]['base_CircularApertureFlux_12_0_fluxSigma'], self.ns[:]['base_CircularApertureFlux_17_0_fluxSigma'],
#				self.ns[:]['flux_aperture_nInterpolatedPixel'][:,0], self.ns[:]['flux_aperture_nInterpolatedPixel'][:,1],
#                               self.ns[:]['flux_aperture_nInterpolatedPixel'][:,2], self.ns[:]['flux_aperture_nInterpolatedPixel'][:,3],
#                                self.ns[:]['flux_aperture_nInterpolatedPixel'][:,4], self.ns[:]['flux_aperture_nInterpolatedPixel'][:,5],
				self.ns[:]['base_GaussianFlux_flux'],
				self.ns[:]['base_GaussianFlux_fluxSigma'], 
				self.ns[:]['ext_photometryKron_KronFlux_flux'], self.ns[:]['ext_photometryKron_KronFlux_fluxSigma'], 
				self.ns[:]['ext_photometryKron_KronFlux_radius'],
				self.ns[:]['ext_photometryKron_KronFlux_psf_radius'], self.ns[:]['base_PsfFlux_flux'], self.ns[:]['base_PsfFlux_fluxSigma'],
#				self.ns[:]['flux_sinc'], self.ns[:]['flux_sinc_err'],
				self.ns[:]['base_PsfFlux_apCorr'], self.ns[:]['base_PsfFlux_apCorrSigma'], 
				self.ns[:]['ext_photometryKron_KronFlux_apCorr'], self.ns[:]['ext_photometryKron_KronFlux_apCorrSigma'],
				self.ns[:]['base_PsfFlux_apCorr'], self.ns[:]['base_PsfFlux_apCorrSigma']]		
