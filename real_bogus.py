...
#				self.real_array[:]['flux_psf_apcorr'], self.real_array[:]['flux_psf_apcorr_err']]
		real_list = [self.real_array[:]['parent'], self.real_array[:]['ext_shapeHSM_HsmSourceMoments_xx'], 
				self.real_array[:]['ext_shapeHSM_HsmSourceMoments_yy'], self.real_array[:]['ext_shapeHSM_HsmSourceMoments_xy'],
				self.real_array[:]['ext_shapeHSM_HsmPsfMoments_xx'], self.real_array[:]['ext_shapeHSM_HsmPsfMoments_yy'],
				self.real_array[:]['ext_shapeHSM_HsmPsfMoments_xy'],
				self.real_array[:]['base_SdssShape_xx'], self.real_array[:]['base_SdssShape_yy'], self.real_array[:]['base_SdssShape_xy'],
				self.real_array[:]['base_SdssShape_psf_xx'], self.real_array[:]['base_SdssShape_psf_yy'], self.real_array[:]['base_SdssShape_psf_xy'],
				self.real_array[:]['base_CircularApertureFlux_3_0_flux'], self.real_array[:]['base_CircularApertureFlux_4_5_flux'], 
				self.real_array[:]['base_CircularApertureFlux_6_0_flux'], self.real_array[:]['base_CircularApertureFlux_9_0_flux'],
				self.real_array[:]['base_CircularApertureFlux_12_0_flux'], self.real_array[:]['base_CircularApertureFlux_17_0_flux'],
				self.real_array[:]['base_CircularApertureFlux_3_0_fluxSigma'], self.real_array[:]['base_CircularApertureFlux_4_5_fluxSigma'], 
				self.real_array[:]['base_CircularApertureFlux_6_0_fluxSigma'], self.real_array[:]['base_CircularApertureFlux_9_0_fluxSigma'],
				self.real_array[:]['base_CircularApertureFlux_12_0_fluxSigma'], self.real_array[:]['base_CircularApertureFlux_17_0_fluxSigma'],
				self.real_array[:]['base_GaussianFlux_flux'],
				self.real_array[:]['base_GaussianFlux_fluxSigma'], 
				self.real_array[:]['ext_photometryKron_KronFlux_flux'], self.real_array[:]['ext_photometryKron_KronFlux_fluxSigma'], 
				self.real_array[:]['ext_photometryKron_KronFlux_radius'],
				self.real_array[:]['ext_photometryKron_KronFlux_psf_radius'], self.real_array[:]['base_PsfFlux_flux'], self.real_array[:]['base_PsfFlux_fluxSigma'],
				self.real_array[:]['base_PsfFlux_apCorr'], self.real_array[:]['base_PsfFlux_apCorrSigma'], 
				self.real_array[:]['ext_photometryKron_KronFlux_apCorr'], self.real_array[:]['ext_photometryKron_KronFlux_apCorrSigma'],
				self.real_array[:]['base_PsfFlux_apCorr'], self.real_array[:]['base_PsfFlux_apCorrSigma']]
 ...
 #                               self.bogus_array[:]['flux_aperture_nInterpolatedPixel'][:,2], self.bogus_array[:]['flux_aperture_nInterpolatedPixel'][:,3],
  #                              self.bogus_array[:]['flux_aperture_nInterpolatedPixel'][:,4], self.bogus_array[:]['flux_aperture_nInterpolatedPixel'][:,5],
	...
	#			self.bogus_array[:]['flux_psf_apcorr'], self.bogus_array[:]['flux_psf_apcorr_err']]
		...
		bogus_list = [self.bogus_array[:]['parent'], self.bogus_array[:]['ext_shapeHSM_HsmSourceMoments_xx'], 
				self.bogus_array[:]['ext_shapeHSM_HsmSourceMoments_yy'], self.bogus_array[:]['ext_shapeHSM_HsmSourceMoments_xy'],
				self.bogus_array[:]['ext_shapeHSM_HsmPsfMoments_xx'], self.bogus_array[:]['ext_shapeHSM_HsmPsfMoments_yy'],
				self.bogus_array[:]['ext_shapeHSM_HsmPsfMoments_xy'],
				self.bogus_array[:]['base_SdssShape_xx'], self.bogus_array[:]['base_SdssShape_yy'], self.bogus_array[:]['base_SdssShape_xy'],
				self.bogus_array[:]['base_SdssShape_psf_xx'], self.bogus_array[:]['base_SdssShape_psf_yy'], self.bogus_array[:]['base_SdssShape_psf_xy'],
				self.bogus_array[:]['base_CircularApertureFlux_3_0_flux'], self.bogus_array[:]['base_CircularApertureFlux_4_5_flux'], 
				self.bogus_array[:]['base_CircularApertureFlux_6_0_flux'], self.bogus_array[:]['base_CircularApertureFlux_9_0_flux'],
				self.bogus_array[:]['base_CircularApertureFlux_12_0_flux'], self.bogus_array[:]['base_CircularApertureFlux_17_0_flux'],
				self.bogus_array[:]['base_CircularApertureFlux_3_0_fluxSigma'], self.bogus_array[:]['base_CircularApertureFlux_4_5_fluxSigma'], 
				self.bogus_array[:]['base_CircularApertureFlux_6_0_fluxSigma'], self.bogus_array[:]['base_CircularApertureFlux_9_0_fluxSigma'],
				self.bogus_array[:]['base_CircularApertureFlux_12_0_fluxSigma'], self.bogus_array[:]['base_CircularApertureFlux_17_0_fluxSigma'],
				self.bogus_array[:]['base_GaussianFlux_flux'],
				self.bogus_array[:]['base_GaussianFlux_fluxSigma'], 
				self.bogus_array[:]['ext_photometryKron_KronFlux_flux'], self.bogus_array[:]['ext_photometryKron_KronFlux_fluxSigma'], 
				self.bogus_array[:]['ext_photometryKron_KronFlux_radius'],
				self.bogus_array[:]['ext_photometryKron_KronFlux_psf_radius'], self.bogus_array[:]['base_PsfFlux_flux'], self.bogus_array[:]['base_PsfFlux_fluxSigma'],
				self.bogus_array[:]['base_PsfFlux_apCorr'], self.bogus_array[:]['base_PsfFlux_apCorrSigma'], 
				self.bogus_array[:]['ext_photometryKron_KronFlux_apCorr'], self.bogus_array[:]['ext_photometryKron_KronFlux_apCorrSigma'],
				self.bogus_array[:]['base_PsfFlux_apCorr'], self.bogus_array[:]['base_PsfFlux_apCorrSigma']]
